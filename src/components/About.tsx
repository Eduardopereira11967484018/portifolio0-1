      ...
      <section className="container mx-auto my-4 max-w-5xl p-4">
        ...
        <div className="mx-auto mt-20 max-w-lg">
          <div className="relative w-full rounded-lg bg-blue-100 p-4 ps-20 md:h-64 md:ps-48">
              ...
              <table className="mt-4 w-full text-sm">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a
                        href="https://api.whatsapp.com/send?phone=5511967484018"
                  ...
                  <tr>
                    ...
                    <td>
                      <a
                        href="eduardopereira.lima@yahoo.com"
                        className="underline hover:text-blue-800"
                      >
                        eduardopereira.lima@yahoo.com
                      </a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <a
                        href="https://goo.gl/maps/HhciD4oXBERjzCKB6"
                        target="_blank"
                        className="underline hover:text-blue-800"
                      >
                        Guarulhos - SP
            ...
            <div className="absolute -left-2 -top-4 h-24 w-20 rounded-lg bg-gray-600 bg-cover bg-center md:-left-12 md:-top-12 md:h-72 md:w-56" style={{ backgroundImage: 'url(./imagens/eu.jpg)' }}>
</div>
