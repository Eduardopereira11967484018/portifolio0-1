...
export default function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 11 967484018",
      link: "https://api.whatsapp.com/send?phone=5511967484018",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "eduardopereira.lima@yahoo.com",
      link: "mailto:eduardopereira.lima@yahoo.com.br?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Guarulhos Pimentas Sitio São Francisco",
      description: "rua Onze, 252",
      link: "https://goo.gl/maps/W8nPGJS5DtC7144n7",
