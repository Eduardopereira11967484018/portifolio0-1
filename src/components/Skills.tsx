...
export default function Skills() {
  const educations = [
    {
      name: "Analise de desenvolvimento de sistemas | Estacio de Sá",
    },
    {
      name: "Curso de React | Dev Samurai",
    },
    {
      name: "Curso de HTML, CSS, javascript's | Curso em Video",
    }
  ...
  const skills = [
    {
      name: "HTML5/CSS3",
      icon: "imagens/html.svg",
      level: 95,
    },
    {
      name: "JavaScript",
      icon: "imagens/javascript.svg",
      level: 90,
    },
    {
      name: "React.js",
      icon: "imagens/react.svg",
      level: 85,
    },
    {
      name: "Node.js",
      icon: "imagens/nodejs.svg",
      level: 65,
    },
  ]
